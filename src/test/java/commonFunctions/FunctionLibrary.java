...
public class FunctionLibrary {
	...
	public static void waitForElement(String Locatorname,String LocatorValue,String TestData)
	{
		...
		//Here we r converting TestData which is in string to integer value, as seconds should be in integer
	...
	public static void clickAction(String LocatorName,String LocatorValue)
	{
		...
		if(LocatorName.equalsIgnoreCase("id"))
		{
			...
			//If we interact with element which is not clickable or does not respond to the click() method 
			//for some reason (e.g., JavaScript event handlers), sending the "Enter" key might simulate a keyboard action 
			//that triggers the desired behavior
		}
		if(LocatorName.equalsIgnoreCase("name"))
		{
	...
	public static void captureStock(String LocatorName,String LocatorValue)throws Throwable
	{
		...
		FileWriter fw = new FileWriter("./Capture/stocknumber.txt");
	...
	public static void stockTable()throws Throwable
	{
		...
		FileReader fr = new FileReader("./Capture/stocknumber.txt");
	...
	public static void captuersupplier(String LocatorName,String LocatorValue)throws Throwable
	{
		...
		FileWriter fw = new FileWriter("./Capture/suppliernumber.txt");
		BufferedWriter bw = new BufferedWriter(fw);
	...
	{
		FileReader fr = new FileReader("./Capture/suppliernumber.txt");
		BufferedReader br = new BufferedReader(fr);
		String Exp_Data = br.readLine();
		if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
			//click ssearch panel button
	...
	//method for customer number to capture into notepad
		public static void captuerCustomer(String LocatorName,String LocatorValue)throws Throwable
		{
			...
			FileWriter fw = new FileWriter("./Capture/customernumber.txt");
			BufferedWriter bw = new BufferedWriter(fw);
		...
		{
			FileReader fr = new FileReader("./Capture/customernumber.txt");
			BufferedReader br = new BufferedReader(fr);
			String Exp_Data = br.readLine();
			if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
				//click ssearch panel button
	...
	//method for date generation, this method is pure java related n not selenium related
	//selenium takes plain screenshot and it wont generate any date so we will create this method to generate date for screenshots	
